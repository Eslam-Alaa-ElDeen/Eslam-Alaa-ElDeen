...
<img src="https://github.com/Eslam-Alaa-ElDeen/Eslam-Alaa-ElDeen/blob/main/i-am-eslam-alaa.gif?raw=true" href="https://github.com/Eslam-3laa" alt="Hello Coders" width="60%"/> <br>
<img src="https://github.com/Eslam-Alaa-ElDeen/Eslam-Alaa-ElDeen/blob/main/i-am-eslam-alaa%20(1).gif?raw=true" href="https://github.com/Eslam-Alaa-ElDeen" alt="I'm Eslam Alaa" width="60%"/> <br>
...
class About {
  constructor() {
    this.tools = {
      programmingLanguages: ["JavaScript", "Java", "C++"],
      webTechnologies: ["HTML", "CSS", "JSON", "React", "Node.js", "Express.js", "Bootstrap", "jQuery", "REST APIs"],
      databases: ["MongoDB", "SQL", "JDBC"],
      toolsAndPlatforms: ["Git", "VSCode", "CLion", "Docker", "Adobe Photoshop", "Adobe Lightroom"],
    };
  }
}
```
...
- 🏋️&nbsp; Gym &nbsp;•&nbsp; ⚽&nbsp; Football &nbsp;•&nbsp; ♟️&nbsp; [Chess.com](https://www.chess.com)
